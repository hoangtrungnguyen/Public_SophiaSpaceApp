...
class SophiaHubGroupedListView<T, E> extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _SophiaHubGroupedListViewState<T, E>();
}

class _SophiaHubGroupedListViewState<T, E>
    extends State<SophiaHubGroupedListView<T, E>> {
