...
class FirebaseConfig {
  ...
  static Future config() async {
    ...
    if (kDebugMode) {
      ...
      FirebaseFirestore.instance.useFirestoreEmulator("172.16.0.226", 8080);
      //TODO [Authentication | <pc_ip>:9099]
      await FirebaseAuth.instance.useAuthEmulator('172.16.0.226', 9099);
      ...
      Future.forEach([0, 1, 2], (_) async {
        ...
        FirebaseFirestore.instance.collection(FirebaseKey.quotes).add(quote.toJson());
      });
