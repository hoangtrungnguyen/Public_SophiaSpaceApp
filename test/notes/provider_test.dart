...
//   late NotesStateManager publisher;
//
//   setUpAll(() {
...
//   group("Các hàm logic", () {
//     setUp(() {
//       publisher = NotesStateManager(
//           repository:
//               NoteRepository(auth: mockFirebaseAuth, firestore: fireStore));
//     });
//
//     tearDown(() async {
...
//       expect(
//           (res.data['note'] as Note).activities.contains(activities[5]), true);
//       expect(
//           (res.data['note'] as Note).activities.contains(activities[2]), true);
//       expect(
//           (res.data['note'] as Note).activities.contains(activities[1]), true);
//     });
//   });
// }
